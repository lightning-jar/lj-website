---
title: "If the Solution Is Not Beautiful, It Is Wrong: Twenty-Five Years of Lightning Jar"
...
imageDescription: A watercolor painting of a birthday cake with lit candles and confetti
author: Kevin Peckham
quote:
  text: "When I am working on a problem I never think about beauty. I only think about how to solve the problem. But when I have finished, if the solution is not beautiful, I know it is wrong."
  attribution: R. Buckminster Fuller
glossary:
  - term: LAMP stack
    definition: "Linux, Apache, MySQL, and PHP: the open-source software combination that powered most of the dynamic web through the 2000s and made database-driven sites cheap to build."
  - term: Responsive design
    definition: An approach where a single site fluidly adapts its layout to any screen size, from phone to desktop, rather than shipping a separate mobile site. It became standard in the early 2010s.
  - term: CMS (Content Management System)
    definition: Software that lets non-developers publish and manage website content. WordPress became the most widespread example.
  - term: SEO (Search Engine Optimization)
    definition: The practice of structuring a site and its content to rank well in search engines. Over the years it grew from a set of tricks into a full professional discipline.
additionalReading:
...
For a while the conversation was *why you need a website*. Then it became *why you need a mobile website*, back when the answer was often a separate stripped-down site at an m-dot address. Then *why you need a responsive website*, once we all agreed that one fluid site should adapt to any screen instead of maintaining two. Then why you need to think about page speed, about accessibility, about structured data, about how an AI assistant will summarize your business when no one visits your homepage at all.
