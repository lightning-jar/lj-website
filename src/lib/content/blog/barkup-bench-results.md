...
***Update (July 2026):*** *A pre-registered follow-up at 300 to 1000 nodes found the crossover: whole-tree rewrite becomes frontier-model-only above a few hundred nodes while id-anchored patches hold for both tiers; details in the [barkup 0.2 post](/blog/barkup-0-2-anchored-patches) update.*
