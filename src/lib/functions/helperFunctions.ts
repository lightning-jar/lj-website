// slugify
export const slugify = (string: string) => string.replace(/ /g, '-').toLowerCase();
...
export const underscorify = (string: string) => string.replace(/\s/ig, '_')
