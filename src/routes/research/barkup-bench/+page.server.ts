...
export function load() {
	return {
		...
		meta: {
			...
			description:
				"barkup-bench is Lightning Jar's open, pre-registered benchmark series measuring how LLMs read and edit structured document trees: twenty-two studies, more than 15,000 scored model runs, published as found, corrections included.",
			robotsFollow: true,
			analyticsOn: true,
		},
	};
