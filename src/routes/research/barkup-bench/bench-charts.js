	...
	(() => {
		...
		table(
			...
			[
				...
				["adjacent, anchored exploratory reading", "48/48", "48/48", "48/48"],
				["adjacent empty cells (any arm)", "0", "0", "0"],
				[
					"covered + trap discipline (min across arms)",
					"23/24",
					"24/24",
					"23/24",
				],
				[
					"mints accepted / attempted (guard never fired)",
					"26/26",
					"10/10",
					"4/4",
				],
	...
	(() => {
		...
		table(
			...
			[
				...
				[
					"no-op guard (under-cap, fence arm)",
					"20/20",
					"20/20",
					"20/20",
					"20/20",
				...
				[
					"declaration landed (min across arms)",
					"40/40",
					"39/40",
					"40/40",
					"40/40",
	...
	(() => {
		...
		table(
			...
			[
				...
				[
					"no-op guard (under-cap, headroom arm)",
					"20/20",
					"19/20",
					"20/20",
					"20/20",
